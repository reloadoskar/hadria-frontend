...
import ResumenProductos from '../dashboard/ResumenProductos'
import ResumenBig from '../dashboard/ResumenBig'
import ResumenVentas from '../dashboard/ResumenVentas'
import DetalleVentas from '../dashboard/DetalleVentas'
import DetalleGastos from '../dashboard/DetalleGastos'
import DetallePagos from '../dashboard/DetallePagos'

const Transition = React.forwardRef(function Transition(props, ref) {
    return <Zoom in ref={ref} {...props} />;
});

export default function VerCompra({ compra, isOpen, handleClose, cerrar }) {

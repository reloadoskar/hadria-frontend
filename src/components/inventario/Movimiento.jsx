            ...
            <Grid item xs={6} sm={1}>
                {mov.pesadas.length>0?
                    <React.Fragment>
                        ...
                        <ListaPesadas pesadas={mov.pesadas} total={ formatNumber(mov.pesadas.reduce((acc,psd)=>acc+=parseFloat(psd),0),2)} open={verPesadas} close={()=>setVerPesadas(false)} noDelete/>
                    </React.Fragment>
                    : null
                }
            </Grid>

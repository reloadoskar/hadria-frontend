...
import { Card, CardHeader, CardContent, Table, TableHead, TableRow, TableCell, TableBody, Typography } from '@material-ui/core';
import { 
    sumImporte,
    formatNumber,
} from '../Tools'
    ...
    return(
        <Card>
            ...
            <CardContent>
                {
                    gastos.length === 0 ?
                        <Typography variant="h6" align="center" children="No se encontraron gastos." />
                    :
                    <Table size="small">
                        <TableHead>
                            <TableRow>
